...
const ParentLogin: React.FC = () => {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (login(email, password, UserRole.Parent)) {
            navigate('/dashboard');
        } else {
    ...
    const handleSignUp = (e: React.FormEvent) => {
        ...
        if (signUp(signName, signEmail, signPassword, UserRole.Parent, { uniqueId: signUniqueId, instituteName })) {
            navigate('/dashboard');
        } else {
                ...
                <Card>
                    {isLogin ? (
                        ...
                        <form onSubmit={handleSignUp} className="space-y-4">
                            ...
                            <Input id="signPassword" label="Password" type="password" value={signPassword} onChange={e => setSignPassword(e.target.value)} required />
