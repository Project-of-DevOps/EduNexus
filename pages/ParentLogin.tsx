...
const ParentLogin: React.FC = () => {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (login(email, password, UserRole.Parent, { orgType: signInOrgType })) {
            navigate('/dashboard');
        } else {
    ...
    const handleSignUp = (e: React.FormEvent) => {
        ...
        if (signAccessCode.trim()) {
            const result = submitOrgJoinRequest({ code: signAccessCode.trim(), name: signName, email: signEmail, role: UserRole.Parent, orgType: signUpOrgType });
        ...
        if (signUp(signName, signEmail, signPassword, UserRole.Parent, { uniqueId: signUniqueId, instituteName, orgType: signUpOrgType })) {
            navigate('/dashboard');
        } else {
        ...
        <div className="min-h-screen flex items-center justify-center bg-[rgb(var(--background-color))] px-4 text-gray-900">
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-lg font-bold text-gray-900">Parent Portal</p>
                </div>
                <Card>
                    {isLogin ? (
